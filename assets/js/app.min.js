! function(a) {
    ...
    t.prototype._reset = function() {
        this.body.removeAttr("data-leftbar-theme"), a("#side-main-logo").attr("src", "assets/images/logo.png"), a("#side-sm-main-logo").attr("src", "assets/images/logo_sm.png")
        ...
        this._reset(), a("#side-main-logo").attr("src", "assets/images/logo-dark.png"), a("#side-sm-main-logo").attr("src", "assets/images/logo_sm_dark.png"), this.body.attr("data-leftbar-theme", "light")
...
function(a) {
    ...
    t.prototype._saveConfig = function(t) {
        ...
        if (767 <= this.window.width() && this.window.width() <= 1028) this.activateCondensedSidebar(!0);
        else {
...
function(e) {
    ...
    t.prototype.initTooltipPlugin = function() {
        ...
        this.initTooltipPlugin(), this.initPopoverPlugin(), this.initToastPlugin(), this.initFormValidation(), this.initSyntaxHighlight()
